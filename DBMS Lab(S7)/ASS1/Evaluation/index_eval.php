...
CGPA:&emsp;&emsp;&emsp;<input type="text" name="cgpa" ><br><br>
...
<input type="submit" name="btn_submit" value="Count" />
</form>
...
{
if(  (empty($rollno))  ||  (empty($firstname))  ||  (empty($lastname))  || (empty($email)) || (empty($cgpa))        ){
echo "Please fill all fields in the form";
}
else{
...
fputcsv($handle, [$firstname,$lastname,$rollno,$email,$cgpa]);
...
else if($_POST['btn_submit']=="Count")
{

echo "You pressed Count";
